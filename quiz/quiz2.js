...
<input type="button" id="multiply" value="4, 7" onclick="MultiplyNumbers(document.getElementById('multiple 4 x7').value)">
...
//      Add a JS created listener click event to this button that calls the welcome function above.
    ...
    <input type="button" id="Display Welcome" value="welcome" onclick="addEventListener(welcomeMessage().value)">
// 1 ex pt
